<div
    x-data="{type:'all',query:@entagle('query')}"
    x-init="
        setTimeout(()=>{
    ...
    <main class="overflow-y-scroll overflow-hidden grow h-full relative" style="contain:content">
        ...
        <ul class="p-2 grid w-full space-y-2">
            ...
            class="py-3 hover:bg-gray-50 rounded-2xl dark:bg-gray-700/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{$conversation->id == $selectedConversation?->id?'bg-gray-100/70':''}}">
                <a href="#" class="shrink-0">
                    <x-avatar src="https://picsum.photos/500/{{$key}}" />
                </a>
                <aside class="grid grid-cols-12 w-full">
                    <a href="{{route('chat',$conversation->id)}}" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                        ...
                        <div class="flex justify-between w-full items-center">
                            ...
                            <h6 class="truncate font-medium tacking-wider text-gray-500">
                        ...
                        <div class="flex gap-x-2 items-center">
                            ...
                            <p class="grow truncate text-sm font-[100]">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Expedita, est possimus. Atque distinctio ut sunt. Tempore vero itaque ipsum hic, dolor cum sed. Expedita ab adipisci eius itaque quod quis?
                            </p>
